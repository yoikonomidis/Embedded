...
static unsigned long long convert_ms_to_ticks (unsigned int milliseconds){
  ...
  read_node_config_reg(adc_tile, XS1_SU_CFG_SYS_CLK_FREQ_NUM, read_val_32); //read MHz setting
...
void at_pm_memory_read_impl(unsigned char data[], unsigned char size){
  ...
  read_periph_8 (adc_tile, XS1_SU_PER_MEMORY_CHANEND_NUM, XS1_SU_PER_MEMORY_BYTE_0_NUM,
      size, data);
}
void at_pm_memory_write_impl(unsigned char data[], unsigned char size){
    ...
    write_periph_8 (adc_tile, XS1_SU_PER_MEMORY_CHANEND_NUM, XS1_SU_PER_MEMORY_BYTE_0_NUM,
      size, data);
}

char at_pm_memory_is_valid(void){
  char val[1];
  read_periph_8 (adc_tile, XS1_SU_PER_MEMORY_CHANEND_NUM, XS1_SU_PER_MEMORY_VALID_NUM, 1, val);
...
void at_pm_memory_validate(void){
  ...
  write_periph_8 (adc_tile, XS1_SU_PER_MEMORY_CHANEND_NUM, XS1_SU_PER_MEMORY_VALID_NUM, 1, val);
}
...
void at_pm_enable_wake_source(at_wake_sources_t wake_source){
  ...
  read_periph_32(adc_tile, XS1_SU_PER_PWR_CHANEND_NUM, XS1_SU_PER_PWR_MISC_CTRL_NUM, 1, &write_val);
  switch (wake_source){
    case RTC:
  ...
  write_periph_32(adc_tile, XS1_SU_PER_PWR_CHANEND_NUM, XS1_SU_PER_PWR_MISC_CTRL_NUM, 1, &write_val);
}
...
void at_pm_sleep_now(void){
  ...
  if (crystal_si_osc_close){
    ...
    write_periph_8(adc_tile, XS1_SU_PER_OSC_CHANEND_NUM, XS1_SU_PER_OSC_ON_SI_CTRL_NUM, 1, &write_val);

    //wait until oscillator is stable
    t :> timeout;
    timeout += (SI_OSC_STABILISATION * 100000);            //Max number of milliseconds to wait
    while (!osc_good){
      read_periph_32(adc_tile, XS1_SU_PER_PWR_CHANEND_NUM, XS1_SU_PER_PWR_PMU_DBG_NUM, 1, &read_val_32);
  ...
  write_periph_32(adc_tile, XS1_SU_PER_PWR_CHANEND_NUM, XS1_SU_PER_PWR_STATE_ASLEEP_NUM, 1, &write_val_32);
  ...
  if (crystal_si_osc_close){
    ...
    write_periph_8(adc_tile, XS1_SU_PER_OSC_CHANEND_NUM, XS1_SU_PER_OSC_GEN_CTRL_NUM, 1, &write_val);
    ...
    write_periph_8(adc_tile, XS1_SU_PER_OSC_CHANEND_NUM, XS1_SU_PER_OSC_XTAL_CTRL_NUM, 1, &write_val);
  }

  //go to sleep
  read_periph_32(adc_tile, XS1_SU_PER_PWR_CHANEND_NUM, XS1_SU_PER_PWR_MISC_CTRL_NUM, 1, &write_val_32);
  write_val_32 = XS1_SU_PWR_SLEEP_INIT_SET(write_val_32, 1);    //Initiate sleep bit
  write_periph_32(adc_tile, XS1_SU_PER_PWR_CHANEND_NUM, XS1_SU_PER_PWR_MISC_CTRL_NUM, 1, &write_val_32);
}
...
void at_pm_set_wake_time(unsigned int alarm_time){
  ...
  write_periph_32(adc_tile, XS1_SU_PER_PWR_CHANEND_NUM, XS1_SU_PER_PWR_WAKEUP_TMR_LWR_NUM, 2, write_val);
}
...
void at_pm_set_min_sleep_time(unsigned int min_sleep_time){
  ...
  read_periph_32(adc_tile, XS1_SU_PER_PWR_CHANEND_NUM, XS1_SU_PER_PWR_STATE_ASLEEP_NUM, 1, &write_val_32);
...
unsigned int at_rtc_read(void){
  ...
  unsigned long long ticks;
  read_periph_32(adc_tile, XS1_SU_PER_RTC_CHANEND_NUM, XS1_SU_PER_RTC_LWR_32BIT_NUM, 2, time_now);
...
void at_rtc_reset(void){
  ...
  write_periph_32(adc_tile, XS1_SU_PER_RTC_CHANEND_NUM, XS1_SU_PER_RTC_LWR_32BIT_NUM, 2, time_now);
}
